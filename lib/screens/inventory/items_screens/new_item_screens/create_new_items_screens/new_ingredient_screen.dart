          ...
          child: Column(
            children: [
                ...
                child: TextFormField(
                  ...
                  onSaved: (value) {
                    ...
                    widget._newDisposableItem = Ingredient(
                      ...
                      maxPackageSupply: ingredient.maxPackageSupply,
                      purchasePrice: ingredient.purchasePrice,
                      packageQuantity: ingredient.packageQuantity,
                      singlePackWeight: ingredient.singlePackWeight,
              ...
              Padding(
                ...
                child: TextFormField(
                  initialValue:
                      widget._newDisposableItem.maxPackageSupply.toString(),
                  ...
                  onSaved: (value) {
                    ...
                    widget._newDisposableItem = Ingredient(
                      ...
                      actualAvailability: ingredient.actualAvailability,
                      dealer: ingredient.dealer,
                      maxPackageSupply: int.parse(value!),
                      purchasePrice: ingredient.purchasePrice,
                      packageQuantity: ingredient.packageQuantity,
                      singlePackWeight: ingredient.singlePackWeight,
                      alcoholic: ingredient.alcoholic,
              ...
              Padding(
                ...
                child: TextFormField(
                  initialValue:
                      widget._newDisposableItem.packageQuantity.toString(),
                  textInputAction: TextInputAction.next,
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(
                  ...
                  onSaved: (value) {
                    ...
                    widget._newDisposableItem = Ingredient(
                      ...
                      maxPackageSupply: ingredient.maxPackageSupply,
                      purchasePrice: ingredient.purchasePrice,
                      packageQuantity: int.parse(value!),
                      singlePackWeight: ingredient.singlePackWeight,
                      alcoholic: ingredient.alcoholic,
                      measureUnit: ingredient.measureUnit,
                      imageUrl: ingredient.imageUrl,
              ...
              Padding(
                ...
                child: TextFormField(
                  initialValue:
                      widget._newDisposableItem.singlePackWeight.toString(),
                  textInputAction: TextInputAction.next,
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(
                  ...
                  onSaved: (value) {
                    ...
                    widget._newDisposableItem = Ingredient(
                      ...
                      purchasePrice: ingredient.purchasePrice,
                      packageQuantity: ingredient.packageQuantity,
                      singlePackWeight: double.parse(value!),
                      alcoholic: ingredient.alcoholic,
                      measureUnit: ingredient.measureUnit,
                      imageUrl: ingredient.imageUrl,
                    );
